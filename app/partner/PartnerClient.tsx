...
const FAQS = [
  {
    q: '계약은 어떻게 진행되나요?',
    a: '본사 운영개발팀에서 직접 연락드려 간단한 상담을 진행한 후, 계약서를 작성합니다. 계약 후 3일 이내에 시스템 세팅이 완료됩니다.',
  },
  {
    q: '식단표는 어떻게 받을 수 있나요?',
  ...
  {
    q: '배송 시간은 언제인가요?',
    a: '매일 새벽 3시부터 식재료 입고를 시작해 오전 10시 30분까지 모든 고객사 배송을 완료합니다. 18대의 냉장 차량이 신선도를 유지하며 운행합니다.',
  },
  {
    q: '식재료는 어떻게 관리되나요?',
