...
export const metadata: Metadata = {
  title: '이달의 신메뉴 | 키즈밀',
  description: '매달 새롭게 선보이는 키즈밀의 메뉴',
};
    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center pt-16">
          ...
          <h1 className="font-serif font-bold text-white text-3xl lg:text-4xl mb-2">이달의 신메뉴</h1>
          <p className="text-white/70 text-sm sm:text-base">매달 새롭게 선보이는 키즈밀의 메뉴</p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((item) => (
              ...
              >
                ...
                <div className="p-5">
                  <span className="inline-block text-xs font-semibold px-2.5 py-1 rounded-full bg-[#E8F5E9] text-[#2D6A4F] mb-2">이달의 신메뉴</span>
