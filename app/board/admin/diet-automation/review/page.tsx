    ...
    <main className="min-h-screen bg-[#F6FAF6] pb-20">
      ...
      <div className="px-4 sm:px-6 space-y-5">
        ...
        {process.env.NEXT_PUBLIC_EMAIL_TEST_MODE === 'true' && (
          <div className="bg-yellow-50 border border-yellow-300 rounded-2xl px-4 py-3 flex items-center gap-2">
            <span className="text-yellow-700 font-bold text-sm">🧪 TEST MODE</span>
            <span className="text-yellow-700 text-sm">이메일이 yuher@kizmeal.com으로만 발송됩니다</span>
          </div>
        )}
