...
export default function ServiceInquiryDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-[#F0F4F0] flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <Link href="/board/admin/service-inquiries" className="text-[#2D6A4F] hover:underline text-sm">
            ← 목록으로
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#F0F4F0]">
      <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3 min-w-0">
          <Link href="/board/admin/service-inquiries" className="text-[#2D6A4F] hover:underline text-sm whitespace-nowrap">
            ← 목록
          </Link>
