  ...
  return (
    <div className="min-h-screen bg-[#F6FAF6] font-sans">
      ...
      <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-4 hidden sm:flex items-center gap-3 sticky top-0 z-10">
        ...
        <div>
          <h1 className="font-bold text-[#1C2B1E]">식단표 디자인 템플릿 관리</h1>
          <p className="text-xs text-gray-400">코드 수정 없이 디자인을 업데이트하세요</p>
        </div>
      </header>
            ...
            <div className="flex items-center justify-between bg-[#E8F5E9] border border-[#B7E4C7] rounded-xl px-4 py-3">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  업로드: {new Date(active.created_at).toLocaleDateString('ko-KR')}
                </p>
              </div>
              <button
                type="button"
