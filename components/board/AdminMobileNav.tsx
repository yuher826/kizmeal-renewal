...
function getPageTitle(pathname: string): string {
  ...
  if (pathname.startsWith('/board/admin/branches'))  return '가맹점 관리'
  if (pathname.startsWith('/board/admin/parents'))   return '학부모 승인'
  if (pathname.startsWith('/board/admin/diet'))      return '식단표 관리'
  if (pathname.startsWith('/board/admin/notices'))   return '공지사항'
